...
class MainCo extends Component {
  ...
  render(){
    ...
    return (
      <Map className="map" center={[12.953328, 77.643104]} zoom={this.state.zoom} style={{overflow : "scroll"}} >
        <ZoomControl position='topright'></ZoomControl>
        <TileLayer
          attribution='&amp;copy <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
          url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
        />
        {/*<Marker position={[12.953328, 77.643104]} icon={this.grenIcon}>*/}
